          ...
          <Card key={index} className="flex justify-between items-center p-2 ">
            ...
            <div className="flex items-center justify-center gap-2">
              <p className="flex items-center text-[1rem]">
                {day.max}
                <span className="text-[0.5rem] text-gray-600">°C</span>
                <FaLongArrowAltUp className="ml-1" size={6} color="#02DB5C" />
              </p>
              <p className="flex items-center text-[1rem]">
                {day.min}
                <span className="text-[0.625rem] text-gray-600">°C</span>
                <FaLongArrowAltDown className="ml-1" size={6} color="#fa4040" />
              </p>
