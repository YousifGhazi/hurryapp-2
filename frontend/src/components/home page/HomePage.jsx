...
const HomePage = () => {
    ...
    const aqi = [{ src: <FaFaceSmile className="mb-1.5" size={20} color="#FFDE30" />, text: "Low" }, { src: <FaFaceMeh className="mb-1.5" size={20} color="#FFDE30" />, text: "Normal" }, { src: <FaFaceFrownOpen className="mb-1.5" size={20} color="#FFDE30" />, text: "Extreme" }]

    return (
        <div className="w-full h-full flex flex-col items-center no-scrollbar">
            <div className="w-full h-full max-w-sm bg-gray-50 flex flex-col gap-8 px-4">
                <div className="w-[60%] flex h-16 justify-between items-center">
                    <BackIcon />
                    ...
                    <div className="w-full min-h-48 flex justify-center relative">
                        <div className="bg-[#adf2ca] w-[70%] h-32 rounded-t-full absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] overflow-hidden">
                            ...
                            <div className="bg-white w-[90%] h-full rounded-t-full absolute top-[58%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-center">
                                <p className=" absolute top-[42%] left-[50%] translate-x-[-50%] translate-y-[-50%] font-lighter flex items-center gap-2 text-base"><span className="text-3xl font-semibold">3</span> AQI</p>
                                <div className="w-full h-[75%] flex items-end justify-center gap-4 mt-4">
                                    <FaFaceSmile className="mb-1.5" size={20} color="#02DB5C" />
                                    <p className="text-center font-bold text-2xl text-[#02DB5C]">Low</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="my-4">
                        ...
                        <div className="w-full h-24 overflow-x-scroll flex items-center gap-3">
                            <div className="min-w-16 h-[90%] flex flex-col justify-center items-center gap-0.5 shadow rounded-md">
                                ...
                                <SmileFace />
                                <p className="text-base font-bold flex justify-center gap-1">3 <span className=" text-[10px] font-normal">AQI</span></p>
                            </div>
                            ...
                            <div className="min-w-16 h-[90%] flex flex-col justify-center items-center gap-0.5 shadow rounded-md">
                                ...
                                <SmileFace />
                                <p className="text-base font-bold flex justify-center gap-1">3 <span className=" text-[10px] font-normal">AQI</span></p>
                            </div>                 <div className="min-w-16 h-[90%] flex flex-col justify-center items-center gap-0.5 shadow rounded-md">
                                <p className=" text-[10x] font-light">17:00</p>
                                <SmileFace />
                                <p className="text-base font-bold flex justify-center gap-1">3 <span className=" text-[10px] font-normal">AQI</span></p>
                            </div>
                ...
                <div className="w-full min-h-[238px] rounded-[8px] bg-white">
                    sdfsd
                </div>

                <div className="w-full min-h-[338px] rounded-[8px] bg-white mb-10">
                    sdfsd
                </div>
